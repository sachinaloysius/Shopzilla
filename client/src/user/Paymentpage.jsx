...
export default function PaymentFunction() {
  ...
  const buttonClickToPay = () => {
    var dat={
      id:bookingid
    }
    axios.post("http://localhost:4777/ClickToPay",dat).then((response) => {
  ...
  return (
    <div className="payment_container">
      <div className="credit-card">
        <div className="credit-card-inner">
          ...
          <div className="credit-card-back">
            ...
            <p className="credits">
              Built with Cleave.js, Anime.js, and React Icons By Sachin Aloysius
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        <Button className="pay_btn" onClick={buttonClickToPay}>
          Click to Pay
          <PaymentIcon />
        </Button>
      </div>
